...
class WebGazerHandler(EyetrackingHandler):
    ...
    def __init__(self, name, participants, dot_color, datafile_suffix):
        super().__init__(name, participants, dot_color)
        self.data_validation = None
        self.datafile_suffix = datafile_suffix
    ...
    def _preprocess(self):
        ...
        for p in self.participants:
            ...
            data_file = f'{settings.DATA_DIR}/{p}_{self.datafile_suffix}.json'
            ...
            for index, trial in enumerate(data):
                ...
                if df_dict['stimulus'] in self.stimulus_blacklist:
                    continue
